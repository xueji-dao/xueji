export default function SetupPage() {
  return (
    <div className="flex min-h-screen flex-col items-center bg-gray-100 px-6 py-12">
      <div className="h-[90vh] w-full max-w-3xl overflow-y-auto rounded-lg border border-gray-300 bg-white p-8 shadow-md">
        <div className="max-w-3xl rounded-lg border border-gray-300 bg-white p-8 shadow-md">
          <h1 className="mb-6 text-3xl font-bold text-gray-900">🛠️ Prisma Postgres Setup Guide</h1>

          <p className="text-gray-700">
            Congratulations, you just deployed the Next.js + Prisma Postgres starter template 🎉
          </p>

          <p className="mt-2 text-gray-700">To make the app work, you need to connect it to a database.</p>

          {/* Step 1 */}
          <div className="mt-6">
            <h2 className="text-2xl font-semibold text-gray-900">1. Create a Prisma Postgres instance</h2>
            <p className="mt-2 text-gray-700">Create a new Prisma Postgres database instance:</p>
          ...
          <div className="mt-6">
            ...
            <p className="mt-2 text-gray-700">
              ...
              in your Netlify account. Next, you need to copy Prisma&apos;s integration token into the extension in your
              Neltify Dashboard:
            </p>
            <ol className="mt-2 list-decimal space-y-1 pl-6 text-gray-700">
              <li>
                ...
                , navigate to the root of your Workspace and click the <strong>Integrations</strong> tab in the
                left-hand sidenav.
              </li>
              <li>
          ...
          <div className="mt-6">
            ...
            <p className="mt-2 text-gray-700">
              {' '}
              Once the deployment is ready, you can click on <strong>Open production deploy</strong> and use the app by
